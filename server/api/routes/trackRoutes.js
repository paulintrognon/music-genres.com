...
router.get('/random', (req, res, next) =>
  next(trackController.getRandomTrack())
);
router.post('/upvote', (req, res, next) =>
  next(trackController.upvoteTrack(req))
);
router.post('/downvote', (req, res, next) =>
  next(trackController.downvoteTrack(req))
);
router.post('/parseUrl', (req, res, next) =>
  next(trackController.parseTrackUrl(req))
);
