...
function createMusicGenreSuite() {
  ...
  it('should make work with parentId singular', testParentIds({ parentId: 1 }, [1]))
  it(
    'should make work with a mix of parentId and parentIds',
    testParentIds({ parentIds: [1, 2], parentId: 3 }, [1, 2, 3])
  )
  it('should make parentIds uniq', testParentIds({ parentIds: [1, 2, 2], parentId: 1 }, [1, 2]))
  it('should work with singular parentIds', testParentIds({ parentIds: 1 }, [1]))
  it('should work with several parentId', testParentIds({ parentId: [1, 2, 3] }, [1, 2, 3]))
